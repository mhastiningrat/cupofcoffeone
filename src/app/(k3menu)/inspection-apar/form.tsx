          ...
          <div className='w-full'>
            <form action="#" className="mx-auto max-w-xl sm:mt-20 w-full">
              <div className="grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-1">
                <div>
                  <label htmlFor="username" className=" text-xs font-semibold text-gray-900">No.APAR</label>
                  <div className="mt-1">
                ...
                <div>
                  <label htmlFor="password" className="block text-xs font-semibold text-gray-900">Lokasi</label>
                  <div className="mt-1">
                ...
                <div>
                  <label htmlFor="password" className="block text-xs font-semibold text-gray-900">Bulan</label>
                  <div className="mt-1">
