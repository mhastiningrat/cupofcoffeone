...
const WorkHighRiskReport = () => {
  return (
    <div><div className="w-full flex justify-between mb-7 bg-[#bee6ff] px-4">
          ...
          <div className="w-full">
            <div className="flex gap-6">
              ...
              <h2 className="text-2xl font-bold">Work High Risk Report</h2>
            </div>
          </div>
          ...
          <div className="h-[500px]"></div></div>
  )
}

export default WorkHighRiskReport